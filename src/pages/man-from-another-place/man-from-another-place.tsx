...
export const ManFromAnotherPlace = () => {
  ...
  return (
    <>
      <div
        id="page-cover"
        className={`page page--the-man sps ${isReady ? "sps--abv" : ""}`}
      >
      ...
      <div id="page-info" className="page-info page-info--man sps">
        <h2>
            ...
            <div className="col-md-6 text-col">
              ...
              <dl>
                ...
                <dd>
                  ...
                  Special Agent Dale Cooper. He said "let's rock" and went to a
                  chair to tell Cooper that the gum he liked was going to come
                  back in style. He described the present Laura Palmer as being
                  his cousin and said she was full of secrets. He said that
                  where he was from, "the birds sing a pretty song and there is
                  always music in the air." He then stood up and began dancing.
                  Laura shared this very same dream days before Cooper.{" "}
                  <a
