  ...
  return (
    <>
      ...
      >
        <div
          id="page-info"
          className={`page page-info--chester-desmond sps ${
              ...
              <div className="col-md-6 text-col">
                ...
                <dl>
                  ...
                  <dd>
                    ...
                    Desmond was called out by Regional Bureau Chief Gordon Cole
                    to investigate the murder of a 17-year-old girl named Teresa
                    Banks, who was found wrapped in plastic. Special Agent Dale
                    Cooper investigated his disappearance and found Desmond's
                    car with the words "Let's rock" scrawled across the
                    windshield.{" "}
                    <a
