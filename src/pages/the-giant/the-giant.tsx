...
export const TheGiant = () => {
  ...
  return (
    <>
      <div
        id="page-cover"
        className={`page page--the-giant sps ${isReady ? "sps--abv" : ""}`}
      >
        <h1>The Giant</h1>
          ...
          <div className="row">
            ...
            <div className="col-md-6 text-col">
              ...
              <dl>
                <dt>Bio:</dt>
                <dd>
                  In March 1989, the Giant appeared at the Great Northern Hotel
                  in FBI Special Agent Dale Cooper's room to tell him three
                  things that he said would come true: "there's a man in a
                  smiling bag," "the owls are not what they seem," and "without
                  chemicals, he points." He then took Cooper's ring and said he
                  would give it back when these things came true. He also said
                  "Leo locked inside hungry horse" and that there was a clue at
                  Leo's home. After telling the special agent he would require
                  medical attention for his gunshot wound, he disappeared.{" "}
                  <a
