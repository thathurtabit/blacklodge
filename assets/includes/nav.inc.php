...
<nav class="navbar navbar-toggleable-sm fixed-top navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarToggler">
    <ul class="navbar-nav">
      <li class="nav-item <?php if (isset($currentPage1)) { echo $currentPage1; } ?>">
      ...
      <li class="nav-item <?php if (isset($currentPage2)) { echo $currentPage2; } ?>">
      ...
      <li class="nav-item <?php if (isset($currentPage3)) { echo $currentPage3; } ?>">
      ...
      <li class="nav-item <?php if (isset($currentPage4)) { echo $currentPage4; } ?>">
      ...
      <li class="nav-item <?php if (isset($currentPage5)) { echo $currentPage5; } ?>">
      ...
      <li class="nav-item <?php if (isset($currentPage6)) { echo $currentPage6; } ?>">
      ...
      <li class="nav-item <?php if (isset($currentPage7)) { echo $currentPage7; } ?>">
      ...
      <li class="nav-item <?php if (isset($currentPage8)) { echo $currentPage8; } ?>">
